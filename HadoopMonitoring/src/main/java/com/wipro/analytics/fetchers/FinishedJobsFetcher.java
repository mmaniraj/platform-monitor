...
public class FinishedJobsFetcher {
    ...
    public JsonNode readJsonNode(URL url) {
        ...
        try {
            ...
            //e.printStackTrace();
            System.out.println("could not find the job related matrices for url :"+url);
            return null;
        }
        return jsonNode;
    }
    ...
    public void getHistoryAppsData(){
        try {
            ...
            for(String jobId : jobIdsArray) {
                ...
                JsonNode jsonNode= readJsonNode(jobURL);
                if (jsonNode!=null){
                JsonNode job = jsonNode.path("job");
               ...
               // writer.write(finishedJobsInfo.toString() + lineSeparator);
                    ...
                    String id = null;
                    if (finishedJobsInfo!=null)
                    id= (String) session.save(finishedJobsInfo);
                     System.out.println("inserted record in database with id is "+id);

...
public class DataFetcherMain 
{
        ...
        try 
	{
            ...
            try 
	    {
                ...
                File directory1 = new File(RUNNING_JOBS_AGGREGATED_DIR);
                ...
                File directory2 = new File(FINISHED_JOBS_AGGREGATED_DIR);
                ...
                File directory3 = new File(HDFS_QUOTA_AGGREGATED_DIR);
                ...
                File directory4 = new File(MR_TASKS_AGGREGATED_DIR);
